...
class Metric(object):
    def __init__(self, name, grad_enabled, context_map=None,
                 reset_event=Event.PHASE_STARTED, update_event=Event.ITER_COMPLETED, multi_update_params=False):
    ...
    def reset(self, engine: Engine, ctx: BaseContext):
        pass
